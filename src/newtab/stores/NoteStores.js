    ...
    db.note
      ...
      .then((res) => {
        if (!res) {
          setTimeout(() => {
            const note = [{
              "content": "<p>欢迎使用便签</p><p>小技巧:</p><ol><li><p>在首屏壁任意地方双击可以快捷添加便签。</p></li><li><p>右击左侧便签列表可以将此标签贴在首屏。</p></li><li><p>在任意网页选中文本右击可以快速将文本添加至便签。</p></li><li><p>任意网页中右击图片也可以快捷添加。</p></li></ol><p></p><p>如果使用中有任何问题可以加 QQ群 429303318</p><p> </p>",
              "sort": 0,
              "state": 1,
            }];
            this.addNote(note)
